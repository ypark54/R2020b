...
LIBMWSF_RUNTIME_API const mxArray* sf_mex_call_debug(emlrtConstCTX aTLS, emlrtMCInfo *aLoc, struct SfDebugInstanceStruct* debugInstance, const char* functionName, unsigned int numReturn, unsigned int numArguments, ...);
