...
LIBMWSF_RUNTIME_API void sf_get_state_configuration_fcn(SimStruct* S, void* stateOut);
LIBMWSF_RUNTIME_API void sf_set_state_configuration_fcn(SimStruct* S, void* stateIn);
