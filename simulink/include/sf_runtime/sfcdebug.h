...
typedef enum
{
    ...
    CV_EML_MCDC_RT_CK,
    CV_EML_SWITCH_RT_CK,
    CV_EML_TESTOBJECTIVE_RT_CK,
    CV_EML_RELATIONAL_RT_CK,
    CV_EML_RT_CK_CNT
} SfCvEmlCheckType;
...
typedef enum
{
    CV_SCRIPT_FCN_RT_CK = 0,
    CV_SCRIPT_IF_RT_CK,
    CV_SCRIPT_FOR_RT_CK,
    CV_SCRIPT_WHILE_RT_CK,
    CV_SCRIPT_COND_RT_CK,
    CV_SCRIPT_MCDC_RT_CK,
    CV_SCRIPT_SWITCH_RT_CK,
    CV_SCRIPT_TESTOBJECTIVE_RT_CK,
    CV_SCRIPT_RELATIONAL_RT_CK,
    CV_SCRIPT_RT_CK_CNT
} SfCvScriptCheckType;
