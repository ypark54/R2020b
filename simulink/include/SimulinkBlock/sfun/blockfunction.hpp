...
namespace RTW {
inline int call_Block_method(Block* pBlock, void (Block::*pMemFun)()) {
    try {
...
inline int call_Block_method(Block* pBlock, void (Block::*pMemFun)(int, int), int i, int j) {
    try {
...
using SFun_BlockFunction = int (*)(CodeConstructor*);

using SFun_PortFunction = int (*)(CodeConstructor*, int, int);

static inline int call_cgStart(CodeConstructor* pCodeCtor) {
    auto* pBlock = static_cast<Block*>(pCodeCtor);
...
SL_CORE_BLOCK_EXPORT_CLASS void SFun_set_cgStart(SFun_BlockFunctionTable* pFcnTable,
                                                 SFun_BlockFunction pfn_call_cgStart);
SL_CORE_BLOCK_EXPORT_CLASS void SFun_set_cgSetupRuntimeResources(
    SFun_BlockFunctionTable* pFcnTable,
    SFun_BlockFunction pfn_call_cgSetupRuntimeResources);
SL_CORE_BLOCK_EXPORT_CLASS void SFun_set_cgInitialize(SFun_BlockFunctionTable* pFcnTable,
                                                      SFun_BlockFunction pfn_call_cgInitialize);
SL_CORE_BLOCK_EXPORT_CLASS void SFun_set_cgSystemInitialize(
    SFun_BlockFunctionTable* pFcnTable,
    SFun_BlockFunction pfn_call_cgSystemInitialize);
SL_CORE_BLOCK_EXPORT_CLASS void SFun_set_cgOutput(SFun_BlockFunctionTable* pFcnTable,
                                                  SFun_BlockFunction pfn_call_cgOutput);
SL_CORE_BLOCK_EXPORT_CLASS void SFun_set_cgUpdate(SFun_BlockFunctionTable* pFcnTable,
                                                  SFun_BlockFunction pfn_call_cgUpdate);
SL_CORE_BLOCK_EXPORT_CLASS void SFun_set_cgCleanupRuntimeResources(
    SFun_BlockFunctionTable* pFcnTable,
    SFun_BlockFunction pfn_call_cgCleanupRuntimeResources);
SL_CORE_BLOCK_EXPORT_CLASS void SFun_set_cgTerminate(SFun_BlockFunctionTable* pFcnTable,
                                                     SFun_BlockFunction pfn_call_cgTerminate);
}
  ...
  public:
    ...
    class rvalue_proxy {
      ...
      public:
        ...
        ~rvalue_proxy() = default;
       
        SFun_BlockFunctionTable_SmartPtr& operator*() {
            return underlying;
        }
    ...
    operator rvalue_proxy() {
        return rvalue_proxy(*this);
    }
...
std::unique_ptr<SFun_BlockFunctionTable, decltype(&SFun_delete_BlockFcnTable)>
build_BlockFunctionTable(DerivedBlock* = NULL) {
   
    std::unique_ptr<SFun_BlockFunctionTable, decltype(&SFun_delete_BlockFcnTable)> pFcnTable(
        SFun_new_BlockFcnTable(), SFun_delete_BlockFcnTable);
