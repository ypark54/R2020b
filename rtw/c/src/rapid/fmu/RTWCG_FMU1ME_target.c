...
void* FMU1_fmuInitializeME( const char * lib, fmiString instanceName, fmiString fmuGUID, fmiString fmuLocation, void* ssPtr, const char * mcclib, const char * mccRes) {
