...
void* FMU1_fmuInitializeCS( const char * lib, fmiString instanceName, fmiString fmuGUID, fmiString fmuLocation, void* ssPtr, const char * mcclib, const char * mccRes){
    return FMU1_fmuInitialize(lib, instanceName, fmuGUID, fmuLocation, ssPtr, mcclib, mccRes);
}

/* fmuPrefix is instanceName */
void* FMU1_fmuInitialize( const char * lib, fmiString instanceName, fmiString fmuGUID, fmiString fmuLocation, void* ssPtr, const char * mcclib, const char * mccRes) {
