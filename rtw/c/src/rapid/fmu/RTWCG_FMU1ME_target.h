...
void * FMU1_fmuInitializeME( const char * lib, fmiString instanceName, fmiString fmuLocation, fmiString fmuGUID, void* ssPtr, const char * mcclib, const char * mccRes);
