...
,NeuDiagnosticManager*);void(*mDestroy)(NeslSimulator*);NeCustomData*(*
mGetCustomData)(const NeslSimulator*);NeslSimulatorStatus(*mSetCustomData)(
const NeCustomData*,const NeslSimulator*,NeuDiagnosticManager*);const NeZCData
*mZCData;const NeRange*mRanges;NeParameterInfo mParameterInfo;void(*
mSetParameters)(const NeslSimulator*,const NeParameterBundle*);};
PMF_DEPLOY_STATIC NeslSimulatorStatus ne_simulator_method(const NeslSimulator*
simulator_ptr,NeslSimulatorMethodId method_id,const NeslSimulationData*
sim_data,NeuDiagnosticManager*mgr){return simulator_ptr->mMethods[method_id](
simulator_ptr,sim_data,mgr);}typedef struct NeProfilerTag NeProfiler;typedef
struct NeSolverParametersTag NeSolverParameters;typedef enum
...
mMaxNonlinIter;size_t mMaxModeIter;boolean_T mComputeImpulses;size_t
mImpulseIterations;NeLinearAlgebraChoice mLinearAlgebra;
...
;NePartitionMethod mPartitionMethod;};typedef struct NeOutputParametersTag{
...
nesl_destroy_current_registry(void);int_T pm_create_sparsity_pattern_fields(
PmSparsityPattern*patternPtr,size_t nNzMax,size_t nRow,size_t nCol,PmAllocator
*allocator);PmSparsityPattern*pm_create_sparsity_pattern(size_t nNzMax,size_t
nRow,size_t nCol,PmAllocator*allocatorPtr);void pm_sp_equals_sp(
PmSparsityPattern*Ap,const PmSparsityPattern*Bp);boolean_T pm_sp_equalequals_sp
(const PmSparsityPattern*Ap,const PmSparsityPattern*Bp);PmSparsityPattern*
...
patternPtr,PmAllocator*allocator);void pm_destroy_sparsity_pattern(
PmSparsityPattern*patternPtr,PmAllocator*allocatorPtr);PmSparsityPattern*
pm_create_full_sparsity_pattern(size_t nrows,size_t ncols,PmAllocator*
allocatorPtr);PmSparsityPattern*pm_create_empty_sparsity_pattern(size_t nrows,
...
PmCharVector*yPtr);boolean_T pm_rv_equalequals_rv(const PmRealVector*xPtr,
const PmRealVector*yPtr);boolean_T pm_iv_equalequals_iv(const PmIntVector*xPtr
,const PmIntVector*yPtr);boolean_T pm_bv_equalequals_bv(const PmBoolVector*
...
PmAllocator*allocatorPtr);int_T pm_create_int_vector_fields(PmIntVector*vecPtr
,size_t size,PmAllocator*allocatorPtr);PmIntVector*pm_create_int_vector(size_t
numElements,PmAllocator*allocatorPtr);PmIntVector*pm_copy_int_vector(const
PmIntVector*vecPtr,PmAllocator*allocatorPtr);void pm_destroy_int_vector_fields
(PmIntVector*vecPtr,PmAllocator*allocatorPtr);void pm_destroy_int_vector(
PmIntVector*vecPtr,PmAllocator*allocatorPtr);int_T pm_create_bool_vector_fields
(PmBoolVector*vecPtr,size_t size,PmAllocator*allocatorPtr);PmBoolVector*
pm_create_bool_vector(size_t numElements,PmAllocator*allocatorPtr);void
...
numElements,PmAllocator*allocatorPtr);void pm_destroy_char_vector_fields(
PmCharVector*vecPtr,PmAllocator*allocatorPtr);void pm_destroy_char_vector(
PmCharVector*vecPtr,PmAllocator*allocatorPtr);int_T
pm_create_size_vector_fields(PmSizeVector*vecPtr,size_t size,PmAllocator*
...
vecPtr,PmAllocator*allocatorPtr);void pm_sv_equals_sv(const PmSizeVector*xPtr,
const PmSizeVector*yPtr);boolean_T pm_sv_equalequals_sv(const PmSizeVector*
xPtr,const PmSizeVector*yPtr);
#ifdef __cplusplus
}
#endif /* __cplusplus */
#include "mc_std.h"
...
PmBoolVector mVPF;PmBoolVector mSLF;PmBoolVector mSLF0;PmSparsityPattern mDXF_P
;PmRealVector mDXF;PmSparsityPattern mDUF_P;PmRealVector mDUF;
PmSparsityPattern mDTF_P;PmRealVector mDTF;PmSparsityPattern mDDF_P;
PmRealVector mDDF;PmSparsityPattern mDPDXF_P;PmRealVector mDPDXF;
...
PmBoolVector mDNF_V_X;PmRealVector mIC;PmRealVector mICR;PmIntVector mICR_IM;
PmBoolVector mICR_ID;PmBoolVector mICR_IL;PmRealVector mDXICR;
PmSparsityPattern mDXICR_P;PmRealVector mDDICR;PmSparsityPattern mDDICR_P;
PmSparsityPattern mTDUICR_P;PmSparsityPattern mICRM_P;PmRealVector mICRM;
PmSparsityPattern mDXICRM_P;PmRealVector mDXICRM;PmSparsityPattern mDDICRM_P;
PmRealVector mDDICRM;PmSparsityPattern mMDUY_P;PmSparsityPattern mMDXY_P;
...
PmRealVector mEQ_TOL;PmBoolVector mLV;PmBoolVector mSLV;PmRealVector mIMIN;
PmRealVector mIMAX;}NeDsMethodOutput;typedef enum NeDsMethodIdTag{
...
,NE_DS_METHOD_VMF,NE_DS_METHOD_VPF,NE_DS_METHOD_SLF,NE_DS_METHOD_SLF0,
NE_DS_METHOD_DXF_P,NE_DS_METHOD_DXF,NE_DS_METHOD_DUF_P,NE_DS_METHOD_DUF,
NE_DS_METHOD_DTF_P,NE_DS_METHOD_DTF,NE_DS_METHOD_DDF_P,NE_DS_METHOD_DDF,
NE_DS_METHOD_DPDXF_P,NE_DS_METHOD_DPDXF,NE_DS_METHOD_DWF_P,NE_DS_METHOD_DWF,
NE_DS_METHOD_TDUF_P,NE_DS_METHOD_TDXF_P,NE_DS_METHOD_DNF_P,NE_DS_METHOD_DNF,
NE_DS_METHOD_DNF_V_X,NE_DS_METHOD_IC,NE_DS_METHOD_ICR,NE_DS_METHOD_ICR_IM,
NE_DS_METHOD_ICR_ID,NE_DS_METHOD_ICR_IL,NE_DS_METHOD_DXICR,
...
NeDynamicSystemInput*,PmRealVector*,boolean_T);struct NeDynamicSystemTag{
size_t mNumIo[NUM_IO_TYPES];const NeDsIoInfo*mIo[NUM_IO_TYPES];size_t
mNumVariables;size_t mNumDiscreteRealVariables;size_t mNumDifferentialVariables
;size_t mNumEquations;size_t mNumICResiduals;size_t mNumModes;size_t
...
mNumEquationRanges;size_t mNumICRRanges;size_t mNumFundamentalSamples;size_t
mNumDelays;size_t mNumLogicalParameters;size_t mNumIntegerParameters;size_t
mNumIndexParameters;size_t mNumRealParameters;size_t
mNumLogicalDerivedParameters;size_t mNumIntegerDerivedParameters;size_t
...
NeDsCreateDsFcn mDiagnosticsDsFcn;NeDsExpandFcn mExpandFcn;NeDsExpandParamFcn
mExpandParamFcn;NeChecksum mChecksum;};PMF_DEPLOY_STATIC void
...
NeSystemInput*input,real_T*sf);typedef PmfMessageId(*StiffDiagnosticMethod)(
const NeSolverSystem*sys,const NeSystemInput*input,void*st);typedef
PmfMessageId(*LinearizationSupportMethod)(const NeSolverSystem*,const
NeSystemInput*,PmRealVector*);typedef PmfMessageId(*VslsSupportMethod)(const
PmRealVector*);typedef void(*EventIterationDiagMethod)(const NeSolverSystem*,
const NeSystemInput*,const PmRealVector*d,const PmIntVector*q,PmCharVector);
...
;StiffDiagnosticMethod mStiffDiagnosticMethod;VslsSupportMethod
mVslsSupportMethod;EventIterationDiagMethod mEventIterationDiagMethod;}
NeSolverSupportMethods;void nes_register_solver_support(const
NeSolverSupportMethods*methods);const NeSolverSupportMethods*
nes_get_support_methods(void);typedef struct NeuDiagnosticTreePrinterTag
NeuDiagnosticTreePrinter;typedef struct NeuDiagnosticTreePrinterPrivateDataTag
...
neu_create_diagnostic_tree_printer(PmAllocator*alloc);const char*
neu_tree_viewer_get_id(const NeuDiagnosticTree*tree);const char*
...
PmRealVector mINIT_DIFF;}GmtMethodOutput;typedef enum GmtMethodIdTag{
GMT_INVALID_METHOD_ID= -1,GMT_METHOD_MODE,GMT_METHOD_Y,GMT_METHOD_OBS,
GMT_METHOD_ASSERT,GMT_METHOD_IASSERT,GMT_METHOD_INIT_R,GMT_METHOD_INIT_I,
GMT_METHOD_CACHE_R,GMT_METHOD_CACHE_I,GMT_METHOD_UPDATE_R,GMT_METHOD_UPDATE_I,
GMT_METHOD_LOCK_R,GMT_METHOD_LOCK_I,GMT_METHOD_UPDATE2_R,GMT_METHOD_UPDATE2_I,
GMT_METHOD_LOCK2_R,GMT_METHOD_LOCK2_I,GMT_METHOD_DP_L,GMT_METHOD_DP_I,
GMT_METHOD_DP_J,GMT_METHOD_DP_R,GMT_METHOD_INIT_DIFF,GMT_NUM_METHODS}
GmtMethodId;typedef int32_T(*GmtMethod)(const GlobalMethodTable*,const
NeDynamicSystemInput*,GmtMethodOutput*);struct GlobalMethodTableTag{GmtMethod
mMethods[GMT_NUM_METHODS];size_t mNumY;size_t mNumObsElts;size_t mNumAsserts;
...
NeParameterInfo mParameterInfo;PmIntVector*mModeIndices;PmIntVector*
mObsIsLinear;};typedef struct SwitchedLinearClumpTag SwitchedLinearClump;
typedef union SlcMethodOutputTag{PmSparsityPattern mM_P;PmRealVector mM;
PmSparsityPattern mJ_P;PmRealVector mJ;PmRealVector mFX;PmRealVector mF;
PmRealVector mXNPLUS1;PmIntVector mMODE;}SlcMethodOutput;typedef enum
SlcMethodIdTag{SLC_INVALID_METHOD_ID= -1,SLC_METHOD_M_P,SLC_METHOD_M,
SLC_METHOD_J_P,SLC_METHOD_J,SLC_METHOD_FX,SLC_METHOD_F,SLC_METHOD_XNPLUS1,
SLC_METHOD_MODE,SLC_NUM_METHODS}SlcMethodId;typedef int32_T(*SlcMethod)(const
...
PmRealVector*outputs,real_T time,void*st,const NeuDiagnosticManager*mgr,
boolean_T firstOutput);boolean_T(*mCheck)(const Simulator*solver,const
PmRealVector*inputs,const PmRealVector*states,real_T time,const
NeuDiagnosticManager*mgr);void(*mInitialize)(const Simulator*s,
SimulatorInitializeStartStatus start,SimulatorInitializeEndStatus end,void*rb)
;void(*mPushInfo)(const Simulator*s);void(*mDestroy)(Simulator*solver);};
