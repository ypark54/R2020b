...
#if defined(__QNX__) || defined(__linux__) || defined(__linux) || \
    defined(linux) || (defined(__APPLE_CC__) && (__clang_major__ > 4))
#include <pthread.h>
...
#elif !defined(__clang__) && (defined(_MSC_VER) || defined(__WIN32__) || \
                              defined(WIN32) || defined(_WIN32))
#include <windows.h> /* This should always be first */
