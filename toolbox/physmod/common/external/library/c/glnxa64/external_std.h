...
const size_t*work2);void tlu2_1d_akima_nearest_value_custom_function_(void*in,
const void*out);void tlu2_1d_akima_nearest_derivatives(real_T*fi,const real_T*
...
void tlu2_1d_akima_nearest_2_order_derivatives(real_T*fi,const real_T*basis,
const real_T*basisDerivative,const real_T*basis2OrderDerivative,const size_t*
bin,const real_T*fx,const size_t*n,const real_T*work1,const size_t*work2);void
tlu2_1d_akima_nearest_2_order_derivatives_custom_function_(void*out,const void
*in);void tlu2_1d_akima_nearest_3_order_derivatives(real_T*fi,const real_T*
basis,const real_T*basisDerivative,const real_T*basis2OrderDerivative,const
real_T*basis3OrderDerivative,const size_t*bin,const real_T*fx,const size_t*n,
const real_T*work1,const size_t*work2);void
tlu2_1d_akima_nearest_3_order_derivatives_custom_function_(void*out,const void
*in);void tlu2_1d_akima_linear_process(real_T*x,real_T*fx,const real_T*xs,
const real_T*fs,const size_t*n);void
tlu2_1d_akima_linear_process_custom_function_(void*out,const void*in);void
tlu2_1d_akima_linear_value(real_T*fi,const real_T*basis,const size_t*bin,const
real_T*fx,const size_t*n,const real_T*work1,const size_t*work2);void
...
tlu2_1d_akima_linear_derivatives_custom_function_(void*out,const void*in);void
tlu2_1d_akima_linear_2_order_derivatives(real_T*fi,const real_T*basis,const
real_T*basisDerivative,const real_T*basis2OrderDerivative,const size_t*bin,
const real_T*fx,const size_t*n,const real_T*work1,const size_t*work2);void
tlu2_1d_akima_linear_2_order_derivatives_custom_function_(void*out,const void*
in);void tlu2_1d_akima_linear_3_order_derivatives(real_T*fi,const real_T*basis
,const real_T*basisDerivative,const real_T*basis2OrderDerivative,const real_T*
basis3OrderDerivative,const size_t*bin,const real_T*fx,const size_t*n,const
real_T*work1,const size_t*work2);void
tlu2_1d_akima_linear_3_order_derivatives_custom_function_(void*out,const void*
in);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
size_t*n2,const real_T*work1,const size_t*work2);void
...
basisDerivative2,const size_t*bin2,const real_T*fx,const size_t*n1,const size_t
*n2,const real_T*work1,const size_t*work2);void
tlu2_2d_akima_linear_derivatives_custom_function_(void*out,const void*in);void
tlu2_2d_akima_nearest_2_order_derivatives(real_T*fi,const real_T*basis1,const
real_T*basisDerivative1,const real_T*basis2OrderDerivative1,const size_t*bin1,
const real_T*basis2,const real_T*basisDerivative2,const real_T*
basis2OrderDerivative2,const size_t*bin2,const real_T*fx,const size_t*n1,const
size_t*n2,const real_T*work1,const size_t*work2);void
tlu2_2d_akima_nearest_2_order_derivatives_custom_function_(void*out,const void
*in);void tlu2_2d_akima_linear_2_order_derivatives(real_T*fi,const real_T*
basis1,const real_T*basisDerivative1,const real_T*basis2OrderDerivative1,const
size_t*bin1,const real_T*basis2,const real_T*basisDerivative2,const real_T*
basis2OrderDerivative2,const size_t*bin2,const real_T*fx,const size_t*n1,const
size_t*n2,const real_T*work1,const size_t*work2);void
tlu2_2d_akima_linear_2_order_derivatives_custom_function_(void*out,const void*
in);void tlu2_2d_akima_nearest_3_order_derivatives(real_T*fi,const real_T*
basis1,const real_T*basisDerivative1,const real_T*basis2OrderDerivative1,const
real_T*basis3OrderDerivative1,const size_t*bin1,const real_T*basis2,const
real_T*basisDerivative2,const real_T*basis2OrderDerivative2,const real_T*
basis3OrderDerivative2,const size_t*bin2,const real_T*fx,const size_t*n1,const
size_t*n2,const real_T*work1,const size_t*work2);void
tlu2_2d_akima_nearest_3_order_derivatives_custom_function_(void*out,const void
*in);void tlu2_2d_akima_linear_3_order_derivatives(real_T*fi,const real_T*
basis1,const real_T*basisDerivative1,const real_T*basis2OrderDerivative1,const
real_T*basis3OrderDerivative1,const size_t*bin1,const real_T*basis2,const
real_T*basisDerivative2,const real_T*basis2OrderDerivative2,const real_T*
basis3OrderDerivative2,const size_t*bin2,const real_T*fx,const size_t*n1,const
size_t*n2,const real_T*work1,const size_t*work2);void
tlu2_2d_akima_linear_3_order_derivatives_custom_function_(void*out,const void*
in);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
work1,const size_t*work2);void tlu2_3d_akima_nearest_value_custom_function_(
void*in,const void*out);void tlu2_3d_akima_linear_value(real_T*fi,const real_T
*basis1,const size_t*bin1,const real_T*basis2,const size_t*bin2,const real_T*
basis3,const size_t*bin3,const real_T*fx,const size_t*n1,const size_t*n2,const
size_t*n3,const real_T*work1,const size_t*work2);void
...
basisDerivative3,const size_t*bin3,const real_T*fx,const size_t*n1,const size_t
*n2,const size_t*n3,const real_T*work1,const size_t*work2);void
tlu2_3d_akima_linear_derivatives_custom_function_(void*in,const void*out);void
tlu2_3d_akima_nearest_2_order_derivatives(real_T*fi,const real_T*basis1,const
real_T*basisDerivative1,const real_T*basis2OrderDerivative1,const size_t*bin1,
const real_T*basis2,const real_T*basisDerivative2,const real_T*
basis2OrderDerivative2,const size_t*bin2,const real_T*basis3,const real_T*
basisDerivative3,const real_T*basis2OrderDerivative3,const size_t*bin3,const
real_T*fx,const size_t*n1,const size_t*n2,const size_t*n3,const real_T*work1,
const size_t*work2);void
tlu2_3d_akima_nearest_2_order_derivatives_custom_function_(void*in,const void*
out);void tlu2_3d_akima_linear_2_order_derivatives(real_T*fi,const real_T*
basis1,const real_T*basisDerivative1,const real_T*basis2OrderDerivative1,const
size_t*bin1,const real_T*basis2,const real_T*basisDerivative2,const real_T*
basis2OrderDerivative2,const size_t*bin2,const real_T*basis3,const real_T*
basisDerivative3,const real_T*basis2OrderDerivative3,const size_t*bin3,const
real_T*fx,const size_t*n1,const size_t*n2,const size_t*n3,const real_T*work1,
const size_t*work2);void
tlu2_3d_akima_linear_2_order_derivatives_custom_function_(void*in,const void*
out);void tlu2_3d_akima_nearest_3_order_derivatives(real_T*fi,const real_T*
basis1,const real_T*basisDerivative1,const real_T*basis2OrderDerivative1,const
real_T*basis3OrderDerivative1,const size_t*bin1,const real_T*basis2,const
real_T*basisDerivative2,const real_T*basis2OrderDerivative2,const real_T*
basis3OrderDerivative2,const size_t*bin2,const real_T*basis3,const real_T*
basisDerivative3,const real_T*basis2OrderDerivative3,const real_T*
basis3OrderDerivative3,const size_t*bin3,const real_T*fx,const size_t*n1,const
size_t*n2,const size_t*n3,const real_T*work1,const size_t*work2);void
tlu2_3d_akima_nearest_3_order_derivatives_custom_function_(void*in,const void*
out);void tlu2_3d_akima_linear_3_order_derivatives(real_T*fi,const real_T*
basis1,const real_T*basisDerivative1,const real_T*basis2OrderDerivative1,const
real_T*basis3OrderDerivative1,const size_t*bin1,const real_T*basis2,const
real_T*basisDerivative2,const real_T*basis2OrderDerivative2,const real_T*
basis3OrderDerivative2,const size_t*bin2,const real_T*basis3,const real_T*
...
basis3OrderDerivative3,const size_t*bin3,const real_T*fx,const size_t*n1,const
size_t*n2,const size_t*n3,const real_T*work1,const size_t*work2);void
tlu2_3d_akima_linear_3_order_derivatives_custom_function_(void*in,const void*
out);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
*work2);void tlu2_4d_akima_nearest_value_custom_function_(void*in,const void*
out);void tlu2_4d_akima_linear_value(real_T*fi,const real_T*basis1,const size_t
*bin1,const real_T*basis2,const size_t*bin2,const real_T*basis3,const size_t*
bin3,const real_T*basis4,const size_t*bin4,const real_T*fx,const size_t*n1,
const size_t*n2,const size_t*n3,const size_t*n4,const real_T*work1,const size_t
*work2);void tlu2_4d_akima_linear_value_custom_function_(void*in,const void*
out);void tlu2_4d_akima_nearest_derivatives(real_T*fi,const real_T*basis1,
const real_T*basisDerivative1,const size_t*bin1,const real_T*basis2,const
real_T*basisDerivative2,const size_t*bin2,const real_T*basis3,const real_T*
...
;void tlu2_4d_akima_nearest_2_order_derivatives(real_T*fi,const real_T*basis1,
const real_T*basisDerivative1,const real_T*basis2OrderDerivative1,const size_t
*bin1,const real_T*basis2,const real_T*basisDerivative2,const real_T*
basis2OrderDerivative2,const size_t*bin2,const real_T*basis3,const real_T*
basisDerivative3,const real_T*basis2OrderDerivative3,const size_t*bin3,const
real_T*basis4,const real_T*basisDerivative4,const real_T*
basis2OrderDerivative4,const size_t*bin4,const real_T*fx,const size_t*n1,const
size_t*n2,const size_t*n3,const size_t*n4,const real_T*work1,const size_t*
work2);void tlu2_4d_akima_nearest_2_order_derivatives_custom_function_(void*in
,const void*out);void tlu2_4d_akima_linear_2_order_derivatives(real_T*fi,const
real_T*basis1,const real_T*basisDerivative1,const real_T*
basis2OrderDerivative1,const size_t*bin1,const real_T*basis2,const real_T*
basisDerivative2,const real_T*basis2OrderDerivative2,const size_t*bin2,const
real_T*basis3,const real_T*basisDerivative3,const real_T*
basis2OrderDerivative3,const size_t*bin3,const real_T*basis4,const real_T*
basisDerivative4,const real_T*basis2OrderDerivative4,const size_t*bin4,const
real_T*fx,const size_t*n1,const size_t*n2,const size_t*n3,const size_t*n4,
const real_T*work1,const size_t*work2);void
tlu2_4d_akima_linear_2_order_derivatives_custom_function_(void*in,const void*
out);void tlu2_4d_akima_nearest_3_order_derivatives(real_T*fi,const real_T*
basis1,const real_T*basisDerivative1,const real_T*basis2OrderDerivative1,const
real_T*basis3OrderDerivative1,const size_t*bin1,const real_T*basis2,const
real_T*basisDerivative2,const real_T*basis2OrderDerivative2,const real_T*
basis3OrderDerivative2,const size_t*bin2,const real_T*basis3,const real_T*
basisDerivative3,const real_T*basis2OrderDerivative3,const real_T*
basis3OrderDerivative3,const size_t*bin3,const real_T*basis4,const real_T*
basisDerivative4,const real_T*basis2OrderDerivative4,const real_T*
basis23OrderDerivative4,const size_t*bin4,const real_T*fx,const size_t*n1,
const size_t*n2,const size_t*n3,const size_t*n4,const real_T*work1,const size_t
*work2);void tlu2_4d_akima_nearest_3_order_derivatives_custom_function_(void*
in,const void*out);void tlu2_4d_akima_linear_3_order_derivatives(real_T*fi,
const real_T*basis1,const real_T*basisDerivative1,const real_T*
basis2OrderDerivative1,const real_T*basis3OrderDerivative1,const size_t*bin1,
const real_T*basis2,const real_T*basisDerivative2,const real_T*
basis2OrderDerivative2,const real_T*basis3OrderDerivative2,const size_t*bin2,
const real_T*basis3,const real_T*basisDerivative3,const real_T*
basis2OrderDerivative3,const real_T*basis3OrderDerivative3,const size_t*bin3,
const real_T*basis4,const real_T*basisDerivative4,const real_T*
basis2OrderDerivative4,const real_T*basis3OrderDerivative4,const size_t*bin4,
const real_T*fx,const size_t*n1,const size_t*n2,const size_t*n3,const size_t*
n4,const real_T*work1,const size_t*work2);void
tlu2_4d_akima_linear_3_order_derivatives_custom_function_(void*in,const void*
out);void tlu2_4d_linear_nearest_process(real_T*x1,real_T*x2,real_T*x3,real_T*
...
size_t*n4);void tlu2_4d_linear_nearest_process_custom_function_(void*in,const
void*out);void tlu2_4d_linear_linear_process(real_T*x1,real_T*x2,real_T*x3,
real_T*x4,real_T*f,const real_T*x1s,const real_T*x2s,const real_T*x3s,const
real_T*x4s,const real_T*fs,const size_t*n1,const size_t*n2,const size_t*n3,
const size_t*n4);void tlu2_4d_linear_linear_process_custom_function_(void*in,
const void*out);void tlu2_4d_linear_nearest_value(real_T*fi,const real_T*H1,
const real_T*G1,const size_t*bin1,const real_T*H2,const real_T*G2,const size_t
*bin2,const real_T*H3,const real_T*G3,const size_t*bin3,const real_T*H4,const
real_T*G4,const size_t*bin4,const real_T*f,const size_t*n1,const size_t*n2,
const size_t*n3,const size_t*n4);void
...
size_t*bin1,const real_T*H2,const real_T*G2,const size_t*bin2,const real_T*H3,
const real_T*G3,const size_t*bin3,const real_T*H4,const real_T*G4,const size_t
*bin4,const real_T*f,const size_t*n1,const size_t*n2,const size_t*n3,const
size_t*n4);void tlu2_4d_linear_linear_value_custom_function_(void*in,const void
*out);void tlu2_4d_linear_nearest_derivatives(real_T*fi,const real_T*H1,const
...
size_t*n3,const size_t*n4);void
...
n3,const size_t*n4);void tlu2_4d_linear_linear_derivatives_custom_function_(
void*in,const void*out);
#ifdef __cplusplus
}
#endif /* __cplusplus */
#include "lang_std.h"
...
derivativeOrder,const real_T*x,const real_T*t,const size_t*n);void
tlu2_akima_linear_prelookup_custom_function_(void*out,const void*in);void
tlu2_akima_nearest_prelookup(real_T*basis,size_t*bin,const size_t*
derivativeOrder,const real_T*x,const real_T*t,const size_t*n);void
